    ...
    await TransactionDetail.createMany([
      {
        ...
        transactionId: "8b8ba516-0a27-40f4-ab1a-31e61262e8d2",
        item: "checkup fee",
        cost: 200000,
      },
      {
      ...
      },
      {
        ...
        transactionId: "daddc68c-1843-411e-9d25-5e4258c92d8b",
        item: "checkup fee",
        cost: 200000,
      },
      {
      ...
      },
      {
        ...
        transactionId: "1917b1da-867f-4ee3-a202-ff2b5965d8f4",
        item: "checkup fee",
        cost: 250000,
      },
    ]);
